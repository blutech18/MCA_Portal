...
class Kernel extends HttpKernel
{
    ...
    protected $middleware = [
        ...
        //\Fruitcake\Cors\HandleCors::class, // If installed; otherwise remove or update accordingly
    ...
    protected $middlewareGroups = [
        ...
        \Illuminate\Session\Middleware\StartSession::class, // THIS line starts the session
